...
namespace cereal {
    ...
    namespace detail {
        template<> struct init_binding<Plaza::AudioListener> {
            static inline bind_to_archives<Plaza::AudioListener> const& b = ::cereal::detail::StaticObject< bind_to_archives<Plaza::AudioListener> >::getInstance().bind(); static void unused() {
                (void)b;
            }
        };
    }
    ...
    namespace detail {
        template <> struct PolymorphicRelation<Plaza::Component, Plaza::AudioListener> {
            static void bind() {
                RegisterPolymorphicCaster<Plaza::Component, Plaza::AudioListener>::bind();
            }
        };
    }
};;